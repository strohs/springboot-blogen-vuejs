...
public class PostMapperTest {
    ...
    public void should_mapPostDTOtoPost_when_postDTOtoPost() {
        ...
        PostDTO postDTO = DomainBuilder.buildPostDTO(PARENT_POST_ID, postUserDTO, PARENT_POST_TITLE,
    ...
    public void should_mapPostDTOChild_To_PostChild_when_postDTOtoPost() {
        ...
        PostDTO childDTO = DomainBuilder.buildPostDTO(CHILD1_POST_ID, postUserDTO, CHILD1_POST_TITLE,
