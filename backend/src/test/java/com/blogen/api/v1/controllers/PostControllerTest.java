...
//    WebApplicationContext webCtx;
    ...
    public void setUp() throws Exception {
        ...
        childDTO_1 = DomainBuilder.buildPostDTO(3L, postUserDTO1, "child title", "child text", null, catDTO1, LocalDateTime.now(), new ArrayList<>());
        childDTO_1.setPostUrl(PostController.BASE_URL + "/" + "3");
        childDTO_1.setParentPostUrl(PostController.BASE_URL + "/" + "1");
        postDTO_1 = DomainBuilder.buildPostDTO(1L, postUserDTO1, "post1 title", "post1 text", null, catDTO1, LocalDateTime.now(), new ArrayList<>());
        postDTO_1.setPostUrl(PostController.BASE_URL + "/" + "1");
        postDTO_1.getChildren().add(childDTO_1);
        postDTO_2 = DomainBuilder.buildPostDTO(2L, postUserDTO1, "post2 title", "post2 text", "http://images.com/2", catDTO1, LocalDateTime.now(), new ArrayList<>());
