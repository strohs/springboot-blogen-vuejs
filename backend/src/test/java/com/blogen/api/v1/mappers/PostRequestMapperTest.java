...
public class PostRequestMapperTest {
    ...
    public void setUp() throws Exception {
        ...
        User user1 = DomainBuilder.buildUser(1L, "john11", "John", "Doe",
        ...
        post = DomainBuilder.buildPost(1L, "title", "text", "http://image.to", cat1, user1, null);
    ...
    @Test
    public void shouldNotMapNullFieldsFromRequestDTO_intoPost_when_updatePostFromPostRequestDTO() {
        ...
        //then post.imageUrl should keep its original value
